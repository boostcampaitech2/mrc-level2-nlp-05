...
def run_retrieval(
    ...
    if data_args.retriever_type == 'SparseRetrieval':
        print('----------start_SparseRetrieval----------')
    ...
    elif data_args.retriever_type == 'TFIDF':
        print('----------start_TFIDF----------')
        ...
        print('----------start_elasticsearch----------')
        # df = new_es_retrieval.es_retrieval()
